CREATE USER 'Raccoon'@'localhost' IDENTIFIED VIA mysql_native_password USING '***';GRANT ALL PRIVILEGES ON *.* TO 'Raccoon'@'localhost' REQUIRE NONE WITH GRANT OPTION MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0;CREATE DATABASE IF NOT EXISTS `Raccoon`;GRANT ALL PRIVILEGES ON `Raccoon`.* TO 'Raccoon'@'localhost';GRANT ALL PRIVILEGES ON `Raccoon\_%`.* TO 'Raccoon'@'localhost'; 
